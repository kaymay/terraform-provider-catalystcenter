...
func (p *CcProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewAreaResource,
		NewAreasResource,
		NewAssignAnchorManagedAPLocationsResource,
		...
		NewDeviceReplacementWorkflowResource,
		NewDeviceRoleResource,
		NewDHCPSettingsResource,
		NewDiscoveryResource,
		NewDNSSettingsResource,
		NewDot11beProfileResource,
		NewExternalAuthenticationResource,
		NewExternalAuthenticationAAAAttributeResource,
		...
		NewFabricL3HandoffIPTransitsResource,
		NewFabricL3HandoffSDATransitResource,
		NewFabricL3VirtualNetworkResource,
		NewFabricMulticastReplicationModeResource,
		NewFabricMulticastVirtualNetworkResource,
		NewFabricMulticastVirtualNetworksResource,
		NewFabricPortAssignmentsResource,
		NewFabricPortChannelResource,
		...
		NewPlannedAccessPointPositionResource,
		...
		NewWirelessCleanAirConfigurationResource,
		NewWirelessDeviceProvisionResource,
		NewWirelessFabricMulticastResource,
		NewWirelessInterfaceResource,
		NewWirelessPreAuthACLResource,
...
func (p *CcProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewImagesDataSource,           // manually maintained
		...
		NewExternalAuthenticationDataSource,
		NewExternalAuthenticationAAAAttributeDataSource,
		...
		NewFabricL3HandoffIPTransitsDataSource,
		NewFabricL3HandoffSDATransitDataSource,
		NewFabricL3VirtualNetworkDataSource,
		NewFabricMulticastReplicationModeDataSource,
		NewFabricMulticastVirtualNetworkDataSource,
		NewFabricMulticastVirtualNetworksDataSource,
		NewFabricPortAssignmentsDataSource,
		NewFabricPortChannelDataSource,
		NewFabricSiteDataSource,
		NewFabricVLANToSSIDDataSource,
		NewFabricZoneDataSource,
		NewFloorDataSource,
		NewGlobalCredentialNETCONFDataSource,
		NewIPPoolDataSource,
		NewIPPoolReservationDataSource,
		NewLANAutomationDataSource,
		NewNetworkProfileDataSource,
		NewNetworkProfileForSitesAssignmentsDataSource,
		NewNTPSettingsDataSource,
		NewPlannedAccessPointPositionDataSource,
		NewPnPDeviceDataSource,
		NewPowerProfileDataSource,
		NewProjectDataSource,
		NewProvisionDeviceDataSource,
		NewProvisionDevicesDataSource,
		NewRoleDataSource,
		NewSiteDataSource,
		...
		NewWirelessCleanAirConfigurationDataSource,
		NewWirelessFabricMulticastDataSource,
		NewWirelessInterfaceDataSource,
		NewWirelessPreAuthACLDataSource,
		NewWirelessProfileDataSource,
		NewWirelessProfilePolicyTagDataSource,
		NewWirelessProfileSiteTagDataSource,
		NewWirelessRFProfileDataSource,
		NewWirelessRRMFRAConfigurationDataSource,
